-- Fix specific products offers to check both product_offers table AND applicable_ids
...
BEGIN
    ...
    -- 1. Direct product offer (via products.offer_id)
    SELECT 
        o.id as offer_id,
        o.offer_type::TEXT,
        o.discount_value,
    ...
    -- 2a. Linked offers via product_offers table
    SELECT 
        o.id as offer_id,
        o.offer_type::TEXT,
        o.discount_value,
    ...
    -- 2b. Specific product offers (via applicable_ids array)
    SELECT 
        o.id as offer_id,
        o.offer_type::TEXT,
        o.discount_value,
