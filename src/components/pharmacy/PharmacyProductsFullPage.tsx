  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        console.log('=== PHARMACY PRODUCTS FULL PAGE FILTERING DEBUG ===');
        console.log('PharmacyProductsFullPage - Current User ID:', ID);
        console.log('PharmacyProductsFullPage - Current User Type:', userType);
        console.log('PharmacyProductsFullPage - User Profile:', userProfile);
        console.log('PharmacyProductsFullPage - Total products fetched:', productsData.length);
          ...
          return {
            ...
            sizes: item.product_sizes
              ?.filter((size: any) => {
                ...
                console.log('🔍 PharmacyProductsFullPage - Filtering size:', {
