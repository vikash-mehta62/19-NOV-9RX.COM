...
export const baseUserSchema = z.object({
  ...
  type: z.enum(["pharmacy", "hospital", "group", "vendor", "admin"]),
  status: z.enum(["active", "inactive", "pending"]),
  role: z.enum(["admin", "superadmin", "manager", "staff", "accounting", "warehouse", "user"]),
  adminPermissions: z.array(z.string()).default([]).optional(),
