  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Product Name */}
        <h3 className="font-medium text-gray-900 line-clamp-2 min-h-[48px] hover:text-orange-600 cursor-pointer transition-colors">
          {product.name}
        </h3>
        ...
        <div className="flex items-center gap-1">
          <div className="flex items-center">
            {[1, 2, 3, 4, 5].map((star) => (
              <Star
                key={star}
                className={`w-4 h-4 ${star <= Math.floor(rating) ? 'fill-orange-400 text-orange-400' : 'fill-gray-200 text-gray-200'}`}
              />
            ))}
          </div>
