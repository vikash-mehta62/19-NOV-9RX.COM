...
interface SizeOptionsFieldProps {
      ...
      <div className="grid grid-cols-5 gap-4 items-end">
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => setNewSize({ ...newSize, pricePerCase: e.target.value })}
            placeholder="0.00"
          />
        </div>
        <Button
              ...
              {field.value?.map((size, index) => (
                ...
                >
                  <div className="grid grid-cols-4 gap-6 flex-1">
                    ...
                    <div>
                      <span className="text-sm font-medium">Case Price</span>
                      <p className="text-sm">${size.pricePerCase.toFixed(2)}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium">Stock</span>
                      <p className="text-sm">{size.stock}</p>
                    </div>
                  </div>
                  <Button
                    type="button"
