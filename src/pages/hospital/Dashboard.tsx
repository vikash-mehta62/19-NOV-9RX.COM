...
export default function HospitalDashboard() {
  ...
  // Fetch statistics and featured products
  useEffect(() => {
          ...
          <CardContent>
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="space-y-2 text-center md:text-left">
                <h3 className="text-lg font-semibold text-blue-700">Need medical supplies?</h3>
                <p className="text-gray-600">Place your order quickly with our streamlined ordering process</p>
              </div>
              <Button 
                onClick={() => window.location.href = '/hospital/order'}
                size="lg"
