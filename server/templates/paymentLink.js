                        ...
                        <td style="padding: 16px; border-bottom: 1px solid #e5e7eb;">
                            <div style="display: flex; align-items: center;">
                                ...
                                <div>
                                    ...
                                    <p style="margin: 4px 0 0 0; font-size: 13px; color: #6b7280;">Size: ${item.unitToggle ? [size.size_value, size.size_unit].filter(Boolean).join(' ') : (size.size_value || size.size || size.name || 'N/A')}</p>
